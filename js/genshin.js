...
// main
function main(own, amass_4, amass_5, nextTrue_4,
    nextTrue_5, code, codeTrue, p1, p2, p3) {
    var timer_3 = 0;
    var list_5 = [];
    var up_5 = 0;
    var not_4 = 0;
    ...
    code = parseInt(code);
    amass_4 = parseInt(amass_4);
    amass_5 = parseInt(amass_5);
    ...
    while (own > 0) {
        ...
        // 开启自动使用星辉之后，每次抽卡完，都检查一下星辉个数；当星辉个数大于>=5时，使用星辉增加抽卡次数。
        if (codeTrue && (code >= 5)) {
